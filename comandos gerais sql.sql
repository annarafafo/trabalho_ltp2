...
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('1', 'Processadores');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('2', 'Placas de Vídeo');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('3', 'Memória RAM');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('4', 'Disco Rígido');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('5', 'SSD');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('6', 'Placas-mãe');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('7', 'Coolers');
INSERT INTO `db_loja`.`tb_categoria` (`id_categoria`, `nm_categoria`) VALUES ('8', 'Periféricos');

INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('1', 'Processador Intel Core i7-10700F, 2.9GHz ', '1', 'Processador Intel Core i7-10700F Os novos processadores Intel Core da 10ª Geração oferecem atualizações de desempenho incríveis para melhorar a produtividade e proporcionar entretenimento surpreendente, incluindo até 5,3 GHz, Intel® Wi-Fi 6 (Gig) tecnologia Thunderbolt™ 3, HDR 4K, otimização de sistema inteligentes e muito mais.', '24', '1519.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('2', 'Processador Intel Core i5-12400, 2.5GHz ', '1', 'Processador Intel Core i5-12400 da 12ª Geração para desktop. Com compatibilidade com PCIe 5.0 e 4.0, e compatibilidade com DDR5 e DDR4, os processadores Intel Core i5 da 12ª Geração para desktop foram otimizados para gamers e produtividade, e ajudam a oferecer alto desempenho.  Intel Laminar RM1 incluído na caixa. Compatível com placas-mãe equipadas com chipset Intel série 600. Potência de base do processador 65W.', '15', '1319.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('3', 'Processador AMD Ryzen 5 5600X, 3.7GHz', '1', 'Processador AMD Ryzen 5 5600X Jogue com os melhores 6 núcleos incríveis para quem quer apenas jogar. Imbatível no jogo Obtenha o desempenho de jogos de alta velocidade do melhor processador de desktop do mundo. AMD Ryzen para criadores Codifique mais rápido. Renderize mais rápido. Repita mais rápido. Crie mais e mais rápido com os processadores AMD Ryzen™.', '27', '1119.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('4', 'Processador AMD Ryzen 7 5800X, 3.8GHz ', '1', 'O único com tecnologia AMD 3D V-Cache™, o processador AMD Ryzen 7 5800X permite obter máximo desempenho nos jogos de alta velocidade. Conhecido também como o melhor processador de desktop do mundo, este modelo possui 8 núcleos otimizados para plataformas de jogos FPS e também funciona de maneira excelente para criadores que necessitam de velocidade e processamento dedicado.', '19', '2898.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('5', 'GeForce RTX 2060 VENTUS GP OC', '2', 'Obtenha uma jogabilidade suave e sem interrupções com taxas de atualização de até 240 Hz, além de HDR e muito mais. Este é o melhor monitor de jogos e o equipamento obrigatório para jogadores entusiastas.As GPUs para jogos GeForce RTX vêm carregadas com memória GDDR6 de última geração, suporte para recursos DirectX 12 e muito mais. Isso é gráficos reinventados.', '18', '1499.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('6', 'Placa de Video PNY NVIDIA Geforce RTX 3060Ti Dual Fan, 8GB', '2', 'A GeForce RTX 3060 Ti permite que você jogue os jogos mais recentes usando o poder da Ampere a arquitetura RTX de 2ª geração da NVIDIA. Obtenha um desempenho incrível com Ray Tracing Cores e Tensor Cores aprimorados, novos multiprocessadores de streaming e memória G6 de alta velocidade.Os blocos de construção para a GPU mais rápida e eficiente do mundo, o novo Ampere SM traz 2X a taxa de transferência do FP32 e eficiência de energia aprimorada.', '33', '2799.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('7', 'Placa de Vídeo RTX 3070 Z Trio 8G MSI NVIDIA GeForce Gaming, 8GB GDDR6', '2', 'A GeForce RTX 3070 é equipada com Ampere—a arquitetura RTX de 2ª geração da NVIDIA. Construído com RT Cores e Tensor Cores aprimorados, novos multiprocessadores de streaming e memória G6 de alta velocidade, ele oferece o poder de que você precisa para enfrentar os jogos mais exigentes.A mais recente iteração da icônica série GAMING da MSI mais uma vez traz desempenho, eficiência de baixo ruído e estética que os jogadores hardcore passaram a reconhecer e confiar. Agora você também pode desfrutar de todos os seus jogos favoritos com uma placa de vídeo poderosa que permanece fria e silenciosa. Do jeito que você gosta.', '25', '4599.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('8', 'Placa de Vídeo RX 580 PowerColor Red Dragon AMD Radeon, 8GB GDDR5', '2', 'Ele é baseado na mais recente arquitetura GCN 4 da AMD projetada para GloFo 14nm FinFET que oferece capacidade de VR premium, maior nível de desempenho, VR suave, suporte contínuo para monitores de jogos de última geração e streaming ou gravação de jogos sem CPU.Agora ficou mais fácil do que nunca conectar e usar uma placa gráfica externa Radeon. Com a tecnologia AMD XConnect, os gabinetes de GPU externos configurados com Radeon Graphics podem se conectar e desconectar facilmente a um notebook ultrafino compatível ou 2 em 1 por Thunderbolt 3 1 a qualquer momento, assim como uma unidade flash USB - uma novidade para dispositivos externos GPUs!', '26', '999.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('9', 'Placa de Vídeo GTX 1660 Super Twin Fan Zotac Gaming NVIDIA GeForce, 6GB, GDDR6 ', '2', 'A nova geração de placas gráficas ZOTAC GAMING GeForce GTX SUPER está aqui. Com base na nova arquitetura NVIDIA Turing, prepare-se para ficar rápido e forte.', '14', '1299.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('10', 'Memória XPG Gammix D45, 8GB, 3200MHz, DDR4', '3', 'Memória XPG Gammix D45 O GAMMIX D45 parece e é robusto, com um exterior de alumínio sólido, semelhante a uma armadura, com arestas corpulentas e desempenho robusto. Usando apenas os chips IC e PCBs da mais alta qualidade, o GAMMIX D45 é feito para oferecer estabilidade e desempenho de overclocking ideais.', '45', '249.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('11', 'Memória Kingston Fury Beast, RGB, 8GB, 3200MHz, DDR4, CL16', '3', 'Memória Kingston Fury Beast RGB A memória Kingston FURY Beast DDR4 RGB* proporciona um poderoso aumento de performance para jogos, edição de vídeo e renderização. Com um visual agressivo e luzes RGB* no comprimento do módulo com os efeitos incríveis. A memória Kingston Fury Beast DDR4 RGB* faz o overclock automático para a especificação de maior performance do módulo que seja suportada pelo sistema**, e está pronto para Intel XMP e AMD Ryzen. Com o seu dissipador de calor de perfil baixo, a memória FURY Beast DDR4 RGB* permanece fria e pronta para o seu game. 100% testada na fábrica e amparada por uma garantia vitalícia, a memória Kingston FURY Beast RGB* é a atualização definitiva para seu computador. Os processadores/chipsets da Intel até a 7ª Geração não eram desenvolvidos para suportar módulos de memória DDR4 fabricados com chips DRAM de densidade 16Gbit.', '39', '209.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('12', 'Memória Corsair Vengeance LPX, 8GB, 2666MHz, DDR4, C16', '3', 'A Corsair Vengeance LPX é uma memória de alta performance que foi projetada para overclock de alto desempenho. Seu dissipador de calor foi desenvolvido em alumínio puro, o que possibilita uma dissipação mais rápida, além do PCB (Pure Circuit Board) personalizado para maior controle da temperatura, garantindo um overclock de qualidade superior.', '28', '199.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('13', 'Memória XPG Gammix D60G RGB, 8GB, 3200MHz, DDR4, CL16', '3', 'Módulo de memória XPG SPECTRIX D60G DDR4 RGB A memória XPG SPECTRIX D60G DDR4 apresenta um design único de faixa de luz RGB dupla que oferece a maior área de superfície RGB de qualquer módulo de memória! Além do mais, ele ostenta uma ampla faixa de frequência de 3200 MHz e suporta perfis Intel XMP 2.0 para fácil overclocking.', '15', '269.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('14', 'HD Seagate 2TB BarraCuda, 3.5\'', '4', 'Um modelo versátil e que carregam uma história de mais de 20 anos de alto desempenho da linha, o HD Seagate Barracuda de 3,5” possui 2TB de capacidade para desktops. Eles possuem modos de gerenciamento avançados de energia que ajudam a economizar sem sacrificar o desempenho, além de uma interface SATA de 6Gb/s que otimiza o equipamento para o desempenho máximo.', '22', '299.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('15', 'HD Externo Seagate Expansion, 4TB, USB', '4', 'A unidade portátil Seagate Expansion é compacta e perfeita para viagens. Adicione instantaneamente mais espaço de armazenamento ao seu PC ou Mac e leve arquivos grandes com você quando viajar.', '38', '599.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('16', 'HD WD Purple Surveillance 4TB, 5400RPM, Cache 256MB', '4', 'As unidades WD Purple são projetadas especificamente para vigilância para ajudar a suportar as elevadas flutuações de calor e vibrações do equipamento em ambientes NVR. Uma unidade de desktop comum é construída para funcionar apenas por curtos intervalos, não no ambiente hostil 24 horas por dia, 7 dias por semana, sempre ligado, de um sistema de vigilância de alta definição. Com o WD Purple, você obtém armazenamento confiável de classe de vigilância testado para compatibilidade em uma ampla gama de sistemas de segurança, e alguns de nossos modelos mais recentes (WD22PURZ, WD42PURZ e WD63PURZ) melhoraram a eficiência de energia. A tecnologia AllFrame exclusiva ajuda a reduzir a perda de quadros e melhorar a reprodução geral do vídeo.', '41', '549.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('17', 'SSD 480 GB Kingston A400, SATA, Leitura: 500MB/s e Gravação: 450MB/s', '5', 'A unidade de estado sólido A400 da Kingston aumenta drasticamente a resposta do seu computador com tempos incríveis de inicialização, carregamento e transferência, comparados a discos rígidos mecânicos.Reforçado com uma controladora de última geração para velocidades de leitura e gravação de até 500MB/s e 450MB/s, este SSD é 10x mais rápido do que um disco rígido tradicional para melhor desempenho, resposta ultrarrápida em multitarefas e um computador mais rápido de modo geral. Também mais confiável e durável do que um disco rígido, o A400 é feito com memória Flash.', '75', '199.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('18', 'SSD 128 GB Husky Gaming, 2.5\", SATA III, Leitura: 570MB/s e Gravação: 500MB/s', '5', 'Um novo nível de desempenho para o seu computador gamer com o SSD Husky Gaming!', '54', '78.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('19', 'SSD 240 GB Crucial BX500, SATA, Leitura: 540MB/s e Gravação: 500MB/s', '5', 'Melhore o desempenho: Carregue arquivos rapidamente. Melhore a capacidade de resposta geral do sistema para todos as suas necessidades de computação. Ferramentas para fácil instalação: Nossas instruções simples, software de clonagem e vídeos de como fazer a instalação simples! Milhões de pessoas atualizaram com um SSD Crucial.', '39', '134.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('20', 'SSD 480 GB WD Green PC SN350, PCIe, NVMe, Leitura: 2400MB/s e Gravação: 1650MB/s', '5', 'O SSD WD Green SN350 NVMe pode revitalizar o seu computador velho para o uso diário. Quer você esteja na aula, no shopping, no bate-papo ou surfando, esta unidade por funcionar até quatro vezes mais rápido do que unidades SATA. Como eles não têm peças móveis, os SSDs oferecem um design resistente a choques para ajudar a proteger os seus dados importantes contra pancadas e quedas acidentais. O formato esguio M.2 2280 permite uma atualização rápida e fácil para qualquer computador que tenha um slot NVMe. Além disso, com o Western Digital SSD Dashboard disponível para download, você pode também monitorar a integridade da sua unidade para uma maior paz de espírito. ', '28', '224.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('21', 'SSD 500 GB Kingston NV1, M.2 2280 NVMe, Leitura: 2100MB/s e Gravação: 1700MB/s', '5', 'SSD Kingston NV1 500GB M.2', '32', '284.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('22', 'Placa-Mãe Gigabyte B550M Aorus Elite, AMD AM4, Micro ATX, DDR4', '6', 'As placas-mãe da série de jogos B550 usam um design de MOSFETs PWM + baixo RDS (on) digital de 5 + 3 fases para oferecer suporte aos processadores AMD Ryzen de 3ª geração, oferecendo incrível precisão no fornecimento de energia aos componentes que mais demandam energia, além de oferecer desempenho aprimorado do sistema. Com os conectores NVMe PCIe 4.0 * / 3.0 x4 e PCIe 3.0 x2 M.2, as placas-mãe GIGABYTE levam os usuários a experimentar o modo NVMe ou a conectividade no modo SATA para dispositivos SSD M.2. Com velocidade de transferência de dados de até 64 Gb / s, o design de dois conectores M.2 fornece uma solução de armazenamento ideal, além de oferecer suporte nos modos RAID. As placas-mãe GIGABYTE usam capacitores de áudio de última geração. Esses capacitores de alta qualidade ajudam a fornecer áudio de alta resolução e alta fidelidade para fornecer os efeitos sonoros mais realistas para os jogadores.', '51', '919.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('23', 'Placa-Mãe Gigabyte GA-A320M-H, AMD AM4, mATX, DDR4', '6', 'A solução GIGABYTE M.2 oferece desempenho de armazenamento consideravelmente mais rápido e suporte para interfaces PCIe e SATA * para dispositivos M.2 SSD.', '35', '339.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('24', 'Placa-Mãe ASRock B450M Steel Legend, AMD AM4, mATX, DDR4', '6', 'Placa-mãe ASRock B450M Steel Legend AMD DDR4 Resistente como aço, verdadeira lenda a Steel Legend representa o estado filosófico da sólida durabilidade e irresistível estética. Construída ao redor das especificações e recursos mais exigentes, a série Steel Legend visa os usuários do dia a dia e entusiastas mainstream!Oferecendo uma forte gama de materiais/componentes para assegurar um desempenho estável e confiável.', '64', '719.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('25', 'Placa-Mãe MSI B560M-A PRO, Intel LGA 1200, Intel B560, mATX, DDR4', '6', 'A série PRO da MSI ajuda os usuários a trabalhar de forma mais inteligente, oferecendo uma experiência eficiente e produtiva. Com funcionalidade estável e montagem de alta qualidade, a placa-mãe MSI B560M-A PRO oferece fluxos de trabalho profissionais otimizados, com menos problemas e longevidade.Os SSDs mais rápidos do mundo podem começar a diminuir o desempenho ao aquecer. Parte do design do dissipador de calor da placa-mãe, o M.2 SHIELD FROZR é a solução térmica M.2 da próxima geração para evitar isso, oferecendo a melhor proteção térmica para garantir que o SSD mantenha o máximo desempenho.', '57', '429.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('26', 'Cooler FAN Rise Mode Wind W1, 120mm, LED', '7', 'Cooler FAN Rise Mode Wind W1, 120mm, LED Azul - RM-WN-01-BB', '43', '9.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('27', 'Water Cooler Rise Mode Gamer Black, RGB, 240mm, Preto', '7', 'Controla a temperatura do seu processador, acompanha o ritmo e as exigências dos gamers mais intensos!A placa de base de cobre maximiza a dissipação de calor para oferecer um desempenho superior de resfriamento.', '69', '399.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('28', 'Air Cooler Rise Mode Gamer G800, 180mm, RGB', '7', 'Air Cooler Rise Mode Gamer G800, 180mm, RGB - RM-AC-O8-RGB', '41', '84.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('29', 'Headset Gamer HyperX Cloud Stinger, Drivers 50mm', '8', 'Completa e versátil, a linha de headsets Cloud foi projetada para as necessidades de qualquer nível de jogador. Independente do seu sistema, estilo de jogo e características este headset irá te surpreender. O Cloud Stinger é um modelo licenciado oficialmente pela Xbox, perfeito para jogadores de Xbox One! Conforto, tecnologia e design a sua altura.', '88', '149.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('30', 'Mouse Gamer Razer Deathadder V2 Mini, Chroma, Optical Switch, 6 Botões, 8500DPI + Mouse Grip Tape', '8', 'Com sensor óptico de alta precisão com resolução real de 8500 DPI possui até 300 polegadas por segundo (IPS) / 35 G de aceleração máx, o design ergonômico derivado do Razer DeathAdder, otimizado para mãos menores, faz ser requisitado por todos gamers.', '37', '99.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('31', 'Mouse Gamer Logitech G203 LIGHTSYNC RGB, Efeito de Ondas de Cores', '8', 'Jogue em cores com a nossa tecnologia LIGHTSYNC RGB mais vibrante, com efeitos de ondas de cores personalizáveis. Um show de luzes que reagem ao jogo, áudio ou à cor da sua tela a cada disputa. Escolha uma cor ou uma predefinição de animação divertida ou faça a sua própria. Sincronize com outro equipamento Logitech G LIGHTSYNC para uma combinação perfeita. O design clássico de seis botões oferece conforto e confiança para que você possa explorar, lançar feitiços e jogar como quiser.', '42', '79.99');
INSERT INTO `db_loja`.`tb_produto` (`id_produto`, `nm_produto`, `cd_categoria`, `desc_produto`, `est_produto`, `vlr_produto`) VALUES ('32', 'Teclado Mecânico Gamer Logitech G PRO com Layout US, RGB LIGHTSYNC', '8', 'Construído com e para atletas de eSports para oferecer desempenho, velocidade e precisão em nível de competição, o teclado mecânico para jogos Logitech G PRO vem em um design compacto tenkeyless que libera espaço na mesa para o mouse de baixa sensibilidade. Os Switches GX Blue Clicky proporcionam um clique audível e um feedback tátil para um pressionamento de tecla sólida e segura. O LIGHTSYNC RGB e a memória integrada programável permitem personalizar e armazenar um padrão de iluminação para torneios.', '24', '749.99');


INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('1', 'Acre', 'AC');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('2', 'Alagoas', 'AL');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('3', 'Amapá', 'AP');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('4', 'Amazonas', 'AM');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('5', 'Bahia', 'BA');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('6', 'Ceara', 'CE');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('7', 'Distrito Federal', 'DF');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('8', 'Espiírito Santo', 'ES');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('9', 'Goiás', 'GO');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('10', 'Maranhão', 'MA');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('11', 'Mato Grosso', 'MT');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('12', 'Mato Grosso do Sul', 'MS');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('13', 'Minas Gerais', 'MG');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('14', 'Pará', 'PA');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('15', 'Paraíba', 'PB');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('16', 'Paraná', 'PR');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('17', 'Pernambuco', 'PE');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('18', 'Piauí', 'PI');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('19', 'Rio de Janeiro', 'RJ');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('20', 'Rio Grande do Norte', 'RN');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('21', 'Rio Grande do Sul', 'RS');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('22', 'Rondônia', 'RO');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('23', 'Roraima', 'RR');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('24', 'Santa Catarina', 'SC');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('25', 'São Paulo', 'SP');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('26', 'Sergipe ', 'SE');
INSERT INTO `db_loja`.`tb_estado` (`id_estado`, `nm_estado`, `sgl_estado`) VALUES ('27', 'Tocantins', 'TO');

INSERT INTO tb_cidade (id_cidade, nm_cidade, cd_estado) VALUES
(1, 'Afonso Cláudio', 8),
...
DELIMITER $$
CREATE PROCEDURE sp_03(in endereco int, usuario int)
BEGIN
	INSERT INTO tb_endereco_usuario(cd_endereco, cd_usuario) VALUES (endereco, usuario);
END $$
DELIMITER ;
